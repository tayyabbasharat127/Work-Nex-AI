...
class LeaveETL {
  ...
  async run(month, year, organizationId = null) {
    ...
    try {
      ...
      for (const user of users) {
        const metrics = await this.calculateUserLeaveMetrics(user.id, startDate, endDate, user.organizationId);
   ...
   */
  async calculateUserLeaveMetrics(userId, startDate, endDate, organizationId = null) {
