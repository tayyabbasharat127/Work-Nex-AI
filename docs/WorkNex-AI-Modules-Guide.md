...
EMPLOYEE WORKS
     ↓
Clock In / Clock Out → Attendance Records saved in DB
     ↓
...
│                                          │
▼                        ▼                 ▼
Performance Score    Attrition Risk    Leave Forecast
(How good?)          (Will they quit?) (How many on leave?)
     ↓                    ↓                 ▼
Leaderboard          HR Action List    30-Day Calendar
     ↓
Employee Prediction
(On-demand single employee analysis)
```
