...
export default function EmployeeDashboardRedirect() {
  ...
  useEffect(() => {
    ...
    if (roleId !== "3") {
      // Not employee, redirect to appropriate dashboard
      switch (roleId) {
        case "1":
    ...
    // User is employee, redirect to main employee page
  ...
  return (
    <div style={{
      ...
      <p style={{ color: '#6b7280', fontSize: '16px' }}>Loading Employee Dashboard...</p>
