...
class PerformanceETL {
  ...
  async run(month, year, organizationId = null) {
    ...
    try {
      ...
      for (const user of users) {
        await this.calculateAndStorePerformance(user.id, user.organizationId, m, y, startDate, endDate);
   ...
   */
  async calculateAndStorePerformance(userId, organizationId, month, year, startDate, endDate) {
    // Get attendance data
