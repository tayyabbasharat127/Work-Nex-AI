...
router.use('/staff-categories', require('../modules/staff-categories/staff-category.routes'));
...
router.use('/performance-goals', require('../modules/performance-goals/performance-goals.routes'));
